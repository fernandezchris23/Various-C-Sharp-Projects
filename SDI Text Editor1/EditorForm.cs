...
namespace SDI_Text_Editor
{
    public partial class EditorForm : Form
    {
        ...
        public EditorForm()
        {
            ...
            updateEditorBox();
            UpdateStatusBar(textProperties.fileName, textProperties.textFont.Name, textProperties.textFont.Size + "");
        }
        ...
        public void updateEditorBox()
        {
            ...
            this.toolStripStatusLabel1.Text = textProperties.fileName;
        }
        ...
        private void saveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            textProperties.fileName = ExtractFileName(filename);
            this.toolStripStatusLabel1.Text = textProperties.fileName;
            this.toolStripStatusLabel2.Text = textProperties.textFont.Name;
            this.toolStripStatusLabel3.Text = textProperties.textFont.Size + "";
            fileIsSaved = true;

            SaveToFile(textProperties, filename);
        }

        private void UpdateStatusBar(String fileName, String fontName, String size)
        {
            this.toolStripStatusLabel1.Text = textProperties.fileName;
            this.toolStripStatusLabel2.Text = fontName;
            this.toolStripStatusLabel3.Text = size;
        }
        ...
        private String ExtractFileName(String filePath)
        {
            ...
            return match.Success ? match.Value : "Saved file";
        }
